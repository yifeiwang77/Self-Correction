...
from autodan.string_utils import autodan_PrefixManager
import sys
import time
...
def autodan_sample_control(control_prefixes, score_list, num_elites, batch_size, crossover=0.5,
                           num_points=5, mutation=0.01, API_key=None, reference=None, if_softmax=True, if_api=False):
